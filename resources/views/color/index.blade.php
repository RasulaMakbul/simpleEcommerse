    <x-master>
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h5 class="h2">{{__('Add Color')}}</h5>
            <div class="btn-toolbar mb-2 mb-md-0">

                <a type="button" href="{{route('color.trash')}}" class="btn btn-sm btn-outline-secondary">
        ...
        <form action="{{route('color.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <form class="form-light">
                <div class="d-flex">
                    <div class="col-6">
                        <x-forms.input name="title" class="mt-2" title="Color" type="text" id="title" :value="old('title')" />
                    </div>
                    <div class="col-6">
                        <x-forms.input name="colorCode" class="mt-2" title="Color Code" type="color" id="colorCode" :value="old('colorCode')" />
                    </div>
